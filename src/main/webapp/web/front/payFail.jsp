...
<%--                                <li class="breadcrumb-item active" aria-current="page">支付失败</li>--%>
<%--                            </ul>--%>
                        </nav>
                    </div>
                </div>
    ...
    <div class="process-wrap" style="margin-bottom: 150px;">
    ...
    <div class=" offset-sm-1 text-center" style="margin-bottom: 150px;">
        <p class="icon-addcart"><span><i class="glyphicon glyphicon-remove" ></i></span></p>
        <h2 class="mb-4">支付失败</h2>
        <div >
            <a href="./orderDetails.html"class="btn btn-primary btn-outline-primary"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;查看订单</a>
            <a href="./cart.html"class="btn btn-primary btn-outline-primary"><i class="glyphicon glyphicon-shopping-cart"></i> 返回购物车</a>
