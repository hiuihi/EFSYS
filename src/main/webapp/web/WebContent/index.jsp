...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="../alipay/3" method=post
              target="_blank">
		...
		<form name=tradequery action="../alipay/4" method=post
              target="_blank">
		...
		<form name=traderefund action="../alipay/5" method=post
              target="_blank">
		...
		<form name=tradeclose action="../alipay/2" method=post
              target="_blank">
